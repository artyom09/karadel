...
class VoyagerMessageController extends VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            if ($orderBy && (in_array($orderBy, $dataType->fields()) || !empty($row))) {
                ...
                $dataTypeContent = call_user_func([$query->where('archive', '0')->latest($model::CREATED_AT), $getter]);
            } else {
                $dataTypeContent = call_user_func([$query->where('archive', '0')->orderBy($model->getKeyName(), 'DESC'), $getter]);
            }
    ...
    public function ArchiveMessage (Request $request) {
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            if ($orderBy && (in_array($orderBy, $dataType->fields()) || !empty($row))) {
                ...
                $dataTypeContent = call_user_func([$query->where('archive', '1')->latest($model::CREATED_AT), $getter]);
            } else {
                $dataTypeContent = call_user_func([$query->where('archive', '1')->orderBy($model->getKeyName(), 'DESC'), $getter]);
            }
        ...
        return view('vendor.voyager.messages.archive')->with(compact(
            'actions',
            'dataType',
            'dataTypeContent',
            'isModelTranslatable',
